...
import { JobApplicationActivityModel } from 'src/app/pages/job-application/models/ja-activity.model';
import { JobApplicationModel } from 'src/app/pages/job-application/models/job-application.model';
import { JobApplicationActivityService } from 'src/app/pages/job-application/services/ja-activity.service';
import { JobApplicationActivityFormData } from 'src/app/pages/job-application/types/ja-activity.form.type';
