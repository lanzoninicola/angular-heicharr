...
import { JobApplicationActivityModel } from 'src/app/pages/job-board/models/ja-activity.model';
import { JobApplicationModel } from 'src/app/pages/job-board/models/job-application.model';
import { JobApplicationActivityService } from 'src/app/pages/job-board/services/ja-activity.service';
import { JobApplicationActivityFormData } from 'src/app/pages/job-board/types/ja-activity.form.type';
