...
import { RequestToHireSerializerService } from '../../request-to-hire/services/request-to-hire-serializer.service';
...
import {
  DepartmentDTO,
  DepartmentModel,
} from 'src/app/pages/settings/models/department.model';
import { PicklistModel } from 'src/app/pages/settings/models/picklist.model';
import { BoardTemplateSerializerService } from 'src/app/pages/settings/services/board-template/board-template-serializer.service';
